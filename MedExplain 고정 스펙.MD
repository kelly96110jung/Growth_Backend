...
| **8) API 계약 (고정)** | POST /session/start<br>mode: A \| B<br>source_lang: ko<br>target_lang: en \| zh<br>department: plastic_surgery<br><br>POST /session/{id}/audio<br>body: 오디오 스트림 청크 (streaming)<br><br>이벤트 타입<br>stt_interim / stt_final / transform_ready / warning<br><br>POST /session/{id}/end<br>output1_transcript<br>output2 (translation, terms_found, terms_unknown, warnings) |
